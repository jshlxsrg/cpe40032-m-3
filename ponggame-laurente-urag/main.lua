...
-- where in the paddle will the ball hit
PLAYER_TWO = 0
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball.dx > 0 then
            if ball.x > 100 then
                if PLAYER_TWO < 7 then
                    if player2.y > ball.y then
                        player2.dy = -PADDLE_SPEED
                    elseif player2.y +20 < ball.y then     
                        player2.dy = PADDLE_SPEED       
                    else 
                        player2.dy = 0
                    end
                    ...
                    if player2.y - 3 > ball.y and player2.y - 0 > ball.y then
                        player2.dy = -PADDLE_SPEED
                    elseif player2.y +20 < ball.y and player2.y +23 < ball.y then     
                        player2.dy = PADDLE_SPEED       
                    else 
                        player2.dy = 0
                    end
